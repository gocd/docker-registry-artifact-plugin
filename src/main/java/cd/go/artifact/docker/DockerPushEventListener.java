...
public class DockerPushEventListener implements EventListener {
    ...
    public DockerPushEventListener(PublishArtifactResponse publishArtifactResponse, String imageToPush) {
    ...
    public void onError(String message) {
        ...
        publishArtifactResponse.addError("Failure:" + message);
        pushDone.countDown();
    }
    ...
    public void onEvent(String event) {
        LOG.info(String.format("Docker Push: %s", event));
    }
